      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-bold text-white text-lg">Ventora</span>
            </div>
            <p className="text-sm text-gray-400">
              AI-powered education matching platform helping students find their perfect university.
            </p>
          </motion.div>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400">
            <p>&copy; {currentYear} Ventora. All rights reserved.</p>
            <p>
              Built with <span className="text-red-500">❤️</span> for students worldwide
            </p>
          </div>
        </div>
      </div>
